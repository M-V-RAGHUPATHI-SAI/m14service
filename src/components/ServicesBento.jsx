      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        ...
        >
          <div>
            ...
            <h2 className="font-extrabold text-[#0A0C29]" style={{ fontSize: 'clamp(32px, 4vw, 48px)', letterSpacing: '-0.02em', lineHeight: 1.1 }}>
              Cleaning solutions<br className="hidden sm:block" /> for every space
            </h2>
          </div>
          <Link to="/services" className="text-[#1C3F3A] font-medium text-sm whitespace-nowrap hover:underline">
            View all services →
          </Link>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 auto-rows-auto">
          ...
          <motion.div
            ...
            className="md:col-span-2 bg-[#1C3F3A] text-white rounded-[20px] p-10 flex flex-col min-h-[280px]"
          >
          ...
          >
            ...
            <div className="absolute inset-0" style={{ background: 'linear-gradient(to top, #1C3F3A 0%, transparent 60%)' }} />
          ...
          <motion.div
            ...
            className="bg-white border border-[#e5e7eb] rounded-[20px] p-8 flex flex-col justify-center"
          >
            <div className="font-extrabold text-[#1C3F3A]" style={{ fontSize: '48px', lineHeight: 1 }}>{stats.clients}+</div>
            <div className="text-[#6b7280] mt-2" style={{ fontSize: '14px' }}>Homes cleaned and counting</div>
          </motion.div>

          {/* Card 4 — wide service (col 2-3, row... ) */}
          <motion.div
            custom={3} variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}
            className="md:col-span-2 bg-white border border-[#e5e7eb] rounded-[20px] p-9 flex items-center justify-between gap-6"
          >
            <div>
              <div className="w-11 h-11 rounded-xl bg-[#1C3F3A] text-white flex items-center justify-center mb-4">
                <Icon name={s[2].icon} size={18} />
              </div>
              <h3 className="font-bold text-[#0A0C29]" style={{ fontSize: '22px' }}>{s[2].name}</h3>
              <p className="text-[#6b7280] mt-1" style={{ fontSize: '14px' }}>{s[2].oneliner}</p>
              <Link to="/services" className="text-[#1C3F3A] font-medium mt-3 inline-flex items-center gap-2 group" style={{ fontSize: '14px' }}>
                Learn more <span className="transition-transform group-hover:translate-x-1">→</span>
              </Link>
            </div>
          ...
          >
            <div>
              ...
              <h3 className="font-bold text-[#0A0C29]" style={{ fontSize: '22px' }}>{s[3].name}</h3>
              <p className="text-[#6b7280] mt-1" style={{ fontSize: '14px' }}>{s[3].oneliner}</p>
              <Link to="/services" className="text-[#1C3F3A] font-medium mt-3 inline-flex items-center gap-2 group" style={{ fontSize: '14px' }}>
                Learn more <span className="transition-transform group-hover:translate-x-1">→</span>
              </Link>
            </div>
          ...
          <motion.div
            ...
            className="bg-[#1C3F3A] text-white rounded-[20px] p-8 flex flex-col justify-center items-start"
          >
            ...
            <Link to={businessConfig.ctaPrimary.link} className="mt-5 inline-flex items-center px-6 py-3 rounded-full bg-white text-[#0A0C29] font-bold text-sm hover:bg-[#EBEBE6] transition-colors">
